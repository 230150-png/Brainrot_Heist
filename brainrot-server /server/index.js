...
const { GameRoom, PLOTS_PER_BASE, BELT_TRAVEL_TIME, BELT_CLAIM_RANGE } = require('./gameRoom');
...
app.get('/api/config', (req, res) => {
  res.json({ plotsPerBase: PLOTS_PER_BASE, beltTravelTime: BELT_TRAVEL_TIME, beltClaimRange: BELT_CLAIM_RANGE });
});
